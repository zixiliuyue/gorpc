...
const (
	...
	DefaultResModuleName string = "接收资源"
	// DefaultFaultModuleName the default fault module name
	DefaultFaultModuleName string = "退库资源"
)
...
const (
	// 业务下面的接收资源模块 DefaultResModuleFlag the default resource module flag
	DefaultResModuleFlag int = 1

	// 业务下面的退库资源模块 DefaultFaultModuleFlag the default fault module flag
	DefaultFaultModuleFlag int = 2

	// 环境下的空闲机模块default字段
	DefaultEnvResModuleFlag int = 3

	// 环境下的空闲机模块default字段
	DefaultEnvFaultModuleFlag int = 4
)
const (
